...
describe('E2E-WARNING-CENTER-001 @smoke', () => {
  beforeEach(() => {
  ...
  it('@smoke 用户可在警示中心看到 W-EPC-04', async () => {
    ...
    expect(screen.getByText(/没有 EPC 流程/)).toBeInTheDocument();
    expect(screen.getByTestId('warning-filter-W-EPC-04')).toBeInTheDocument();
  });
});
